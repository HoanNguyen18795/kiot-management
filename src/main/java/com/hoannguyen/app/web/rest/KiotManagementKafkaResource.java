...
@RestController
@RequestMapping("/api/kiot-management-kafka")
public class KiotManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KiotManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KiotManagementKafkaResource(KafkaProperties kafkaProperties) {
